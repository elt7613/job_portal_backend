...
API_URL = "http://18.118.247.36:3000/api/project.all"
api_key = "xTDMcSEvOHvFyomBUOKmWjodbQPwtEIcckByXTHCooltdQmHSMFFkEYjxkwFraaW"
app_name = "job-portal-backend-nuf1sg"
