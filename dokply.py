...
API_URL = "http://3.17.158.82:3000/api/project.all"
api_key = "FJAiSWiVXYOHIhrBhZlkrRemuCyBiNjLwiZuUtXfCEadAJrNwtDgnZyHcaUTXNRN"
app_name = "job-portal-backend-rzm7hg"
